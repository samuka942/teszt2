...
if(empty($_POST['hatarido']) || empty($_POST['IDOZONA']) || empty($_POST['ido_kezdete']) || empty($_POST['szazalek']) || empty($_POST['ido_vege']) || empty($_POST['ido_elso']) || empty($_POST['ido_masod'])){
